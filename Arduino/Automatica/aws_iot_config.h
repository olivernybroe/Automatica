...
//===============================================================
#define AWS_IOT_MQTT_HOST "a2rcd1k48ok85g.iot.eu-central-1.amazonaws.com" // your endpoint
#define AWS_IOT_MQTT_PORT 8883 // your port
#define AWS_IOT_CLIENT_ID      "Automatica" // your client ID
#define AWS_IOT_MY_THING_NAME "Automatica" // your thing name
#define AWS_IOT_ROOT_CA_FILENAME "root-CA.crt" // your root-CA filename
#define AWS_IOT_CERTIFICATE_FILENAME "66aed6c23a-certificate.pem.crt" // your certificate filename
#define AWS_IOT_PRIVATE_KEY_FILENAME "66aed6c23a-private.pem.key" // your private key filename
//===============================================================
